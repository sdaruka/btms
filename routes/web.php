...
Route::post('/customer', [UserController::class, 'storeCustomer'])->name('customers.store.simple');
    ...
    Route::prefix('users')->group(function () {
        ...
        // Route::post('/api/fcm-token', [UserController::class, 'updateFcmToken'])->name('fcm.token');        // New routes for soft deletes and force deletion
    ...
    // Route::post('/api/fcm-token', [App\Http\Controllers\UserController::class, 'updateFcmToken'])->name('fcm.token');
    // Products
