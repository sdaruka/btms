...
<div x-show="showModal" x-transition.opacity
    ...
    <div class="modal-content"
        ...
        <div class="mb-3">
         ...
         {{-- Customer Group --}}
        <div class="mb-3">
    <label for="new-customer-group" class="form-label">Customer Group</label>
    <select id="new-customer-group" class="form-select" x-model="newCustomer.customer_group_id">
